...
import com.digitalservices.Digital.Services.Customer.dao.LoginRepository;
...
public class LoginServiceImpl implements LoginService {
    ...
    public List<Login> findAllByUser(User user) {
        ...
        if (loginList.isEmpty()){
            throw new EntityNotFoundException("Login entries by user " + user.getMobileNumber()+ " not found");
        }
        return loginList;
    }
